...
export default function MainPage() {
  return (
    <section className="card">
      ...
      <p className="txt">Next-UI is a powerful and flexible UI library built with Next.js and TypeScript. Designed to boost developer productivity and code quality, it offers:</p>
      <List spacing={16}>
      ...
      <p className="txt">Next-UI combines high development velocity with robust code quality. Its simple usage boosts productivity while its powerful features and extensibility handle complex requirements. Leverage Next-UI for your Next.js and React projects today.</p>
      <Button disabled spacing={16}>
        See You Soon...
      </Button>
    </section>
  );
